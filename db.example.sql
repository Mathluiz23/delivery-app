...
INSERT INTO users (id, name, email, password, role) VALUES
  ...
  (3, 'Cliente Zé Birita', 'zebirita@email.com', 'b646cc7fd0ffdc786b7c0ba5b101215f', 'customer'); -- senha: md5('$#zebirita#$')
  (4, 'Cliente Maria Birita', 'maria@email.com', '1c37466c159755ce1fa181bd247cb925', 'customer'); -- senha: md5('$#mariabirita#$')
